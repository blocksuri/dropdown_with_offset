...
//    final double offsetAmount = 125;
    final double topOffset = _kMenuItemHeight+offsetAmount;

    final double maxMenuHeight = availableHeight - 2.0 * _kMenuItemHeight - offsetAmount;
    ...
    double topLimit = math.min(topOffset, buttonTop);
    ...
    double menuTop = (buttonTop - selectedItemOffset) - (topOffset - buttonRect.height) / 2.0;
...
class _DropdownButtonState<T> extends State<DropdownButton<T>>
  ...
  void _handleTap() {
    ...
    _dropdownRoute = _DropdownRoute<T>(
      items: widget.items,
      height: widget.height,
      offsetAmount: widget.offsetAmount,
